<template>
  <div class="fixed inset-0 z-[60] flex items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-md bg-[#0a0a0a] rounded-[2rem] p-10 shadow-[0_0_40px_rgba(0,0,0,0.5)] border border-white/10">
      <h2 class="text-2xl font-extrabold text-white mb-1 tracking-tight">Edit Entry</h2>
      <p class="text-slate-500 text-sm mb-8 font-medium">Update the details for this credential.</p>
        ...
        <div>
          ...
          <div class="relative flex items-center">
            <input v-model="form.password" :type="showPw ? 'text' : 'password'" required placeholder="••••••••"
              class="w-full bg-black border border-white/10 rounded-2xl pl-5 pr-20 py-4 text-white focus:bg-[#111] focus:border-white/30 focus:outline-none transition-all placeholder:text-slate-600" />
