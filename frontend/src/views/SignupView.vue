<template>
  <div class="bg-gradient-to-b from-slate-50 via-slate-50 to-slate-100 min-h-screen flex flex-col selection:bg-brand-orange/20 overflow-x-hidden">
    ...
    <main class="flex-1 flex flex-col p-6 pt-28 pb-12 relative">
      ...
      <div class="m-auto w-full max-w-[440px] animate-fade-in z-10">
        <div class="bg-white/80 backdrop-blur-xl rounded-[32px] p-6 sm:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-slate-200/40">
          ...
          <div class="text-center mb-10">
            ...
            <h1 class="text-[30px] font-black text-slate-900 tracking-tight leading-tight font-outfit">Create Account</h1>
            <p class="text-[14px] text-slate-400 font-semibold mt-2">Start your secure zero-knowledge vault</p>
          </div>
          ...
          <Transition name="fade">
            ...
            <div v-else-if="success" class="mb-6 p-4 bg-emerald-50 border border-emerald-100 rounded-2xl text-emerald-600 text-[13px] font-bold text-center">
          ...
          <form @submit.prevent="handleSignup" class="space-y-4">
            ...
            <div class="space-y-1.5">
              <label class="block text-[12px] font-bold text-slate-400 ml-1 uppercase tracking-wider">Full Name</label>
              <div class="relative">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div class="space-y-1.5">
                <label class="block text-[12px] font-bold text-slate-400 ml-1 uppercase tracking-wider">Confirm</label>
                <div class="relative">
                  <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-slate-400 pointer-events-none">
          ...
          <div class="mt-8 text-center">
            <p class="text-[14px] text-slate-400 font-semibold">
              ...
              <router-link to="/login" class="text-brand-orange font-bold hover:opacity-75 transition-opacity ml-1">Log in</router-link>
            </p>
          </div>
        </div>
